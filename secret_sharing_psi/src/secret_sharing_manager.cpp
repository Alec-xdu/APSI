...
// Project
#include "../include/secret_sharing_manager.h"
...
namespace secret_sharing_psi {
        ...
        : modulus_(modulus), num_triples_(num_triples), rng_(random_device{}())
    {
        ...
        cout << "SecretSharingManager initialized with modulus: " << modulus_ 
             << ", num_triples: " << num_triples_ << endl;
    }
    ...
    void SecretSharingManager::distribute_seeds(vector<uint8_t>& seed_a, vector<uint8_t>& seed_b)
    {
        ...
        cout << "Seeds distributed to parties A and B" << endl;
    }
        ...
        vector<pair<uint64_t, uint64_t>>& polynomial_shares)
    {
        ...
        cout << "Computed polynomial powers for " << values.size() 
             << " values with " << powers.size() << " powers each" << endl;
    }
        ...
        vector<uint64_t>& result)
    {
        ...
        cout << "Combined " << shares_a.size() << " polynomial shares" << endl;
    }
